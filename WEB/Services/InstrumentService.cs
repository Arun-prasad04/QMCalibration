...
public class InstrumentService : IInstrumentService
{
	...
	public ResponseViewModel<InstrumentViewModel> GetAllInstrumentList(int userId, int userRoleId)
	{
		try
		{
			...
			{
				instrumentList = _unitOfWork.Repository<Instrument>().GetQueryAsNoTracking(Q => Q.QuarantineModel.Select(s => s.StatusId).FirstOrDefault() == 2 && Convert.ToInt16(Q.ActiveStatus) == 1 && (Q.CreatedBy == userId || Q.UserDept == labUserById.DepartmentId))
					.Include(I => I.QuarantineModel)
					.Include(I => I.FileUploadModel)
					.Include(G => G.DepartmenttModel)
	...
	public ResponseViewModel<InstrumentViewModel> GetInstrumentById(int instrumentId)
	{
		...
		{
			ErrorViewModelTest.Log("InstrumentService - GetInstrumentById Method");
			ErrorViewModelTest.Log("exception - " + e.Message);
			return new ResponseViewModel<InstrumentViewModel>
			{
				ResponseCode = 500,
	...
	public ResponseViewModel<InstrumentViewModel> DeleteInstrument(int instrumentId)
	{
		...
		catch (Exception e)
		{
			...
			ErrorViewModelTest.Log("InstrumentService - DeleteInstrument Method");
			ErrorViewModelTest.Log("exception - " + e.Message);
			return new ResponseViewModel<InstrumentViewModel>
			{
				ResponseCode = 500,
	...
	public ResponseViewModel<InstrumentViewModel> CreateNewInstrument()
	{
		...
		{
			ErrorViewModelTest.Log("InstrumentService - CreateNewInstrument Method");
			ErrorViewModelTest.Log("exception - " + e.Message);
			return new ResponseViewModel<InstrumentViewModel>
			{
				ResponseCode = 500,
	...
	public ResponseViewModel<InstrumentViewModel> InstrumentQuarantine(int instrumentId, string reason, int userId, int statusId)
	{
		...
		{
			_unitOfWork.RollBack();
			ErrorViewModelTest.Log("InstrumentService - InstrumentQuarantine Method");
			ErrorViewModelTest.Log("exception - " + e.Message);
			return new ResponseViewModel<InstrumentViewModel>
			{
				ResponseCode = 500,
	...
	public ResponseViewModel<InstrumentViewModel> InstrumentRemoveQuarantine(int instrumentId, int statusId, int userId)
	{
		...
		{
			_unitOfWork.RollBack();
			ErrorViewModelTest.Log("InstrumentService - InstrumentRemoveQuarantine Method");
			ErrorViewModelTest.Log("exception - " + e.Message);
			return new ResponseViewModel<InstrumentViewModel>
			{
				ResponseCode = 500,
	...
	public ResponseViewModel<InstrumentViewModel> GetInstrumentListByName(string instrumentName)
	{
		...
		{
			ErrorViewModelTest.Log("InstrumentService - GetInstrumentListByName Method");
			ErrorViewModelTest.Log("exception - " + e.Message);
			return new ResponseViewModel<InstrumentViewModel>
			{
				ResponseCode = 500,
	...
	public ResponseViewModel<InstrumentViewModel> GetInstrumentListByIdNo(string idNo)
	{
		...
		{
			ErrorViewModelTest.Log("InstrumentService - GetInstrumentListByIdNo Method");
			ErrorViewModelTest.Log("exception - " + e.Message);
			return new ResponseViewModel<InstrumentViewModel>
			{
				ResponseCode = 500,
	...
	public ResponseViewModel<InstrumentViewModel> GetCurrentMonthDueList()
	{
		...
		{
			ErrorViewModelTest.Log("InstrumentService - GetCurrentMonthDueList Method");
			ErrorViewModelTest.Log("exception - " + e.Message);
			return new ResponseViewModel<InstrumentViewModel>
			{
				ResponseCode = 500,
