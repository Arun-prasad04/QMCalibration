...
namespace WEB.Services
{
	public class QRCodeGeneratorService : IQRCodeGeneratorService
	{
		...
		public ResponseViewModel<QRCodeFilesViewModel> InsertQRCodeFiles(List<QRCodeFilesViewModel> qrCodeFilesViewModels)
		{
			...
			{
				ErrorViewModelTest.Log("QRCodeGeneratorService - InsertQRCodeFiles Method");
		...
		public QRCodeFilesViewModel GetQRCodeByGuid(Guid guid)
		{
			...
			{
				ErrorViewModelTest.Log("QRCodeGeneratorService - GetQRCodeByGuid Method");
				ErrorViewModelTest.Log("exception - " + ex.Message);
				return new QRCodeFilesViewModel() { };
			}
		}
		...
		public RequestViewModel GetRequestData(int requestId)
		{
			...
			{
				ErrorViewModelTest.Log("QRCodeGeneratorService - GetRequestData Method");
				ErrorViewModelTest.Log("exception - " + ex.Message);
