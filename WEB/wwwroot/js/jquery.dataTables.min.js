...
fnInitComplete:null,fnPreDrawCallback:null,fnRowCallback:null,fnServerData:null,fnServerParams:null,fnStateLoadCallback:function(a){try{return JSON.parse((-1===a.iStateDuration?sessionStorage:localStorage).getItem("DataTables_"+a.sInstance+"_"+location.pathname))}catch(b){}},fnStateLoadParams:null,fnStateLoaded:null,fnStateSaveCallback:function(a,b){try{(-1===a.iStateDuration?sessionStorage:localStorage).setItem("DataTables_"+a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,
    iStateDuration: 7200, iDeferLoading: null, iDisplayLength: 10, iDisplayStart: 0, iTabIndex: 0, oClasses: {}, oLanguage: {
        oAria: { sSortAscending: ": activate to sort column ascending", sSortDescending: ": activate to sort column descending" }, oPaginate: { sFirst: "<span class='trn'>First</span>", sLast: "<span class='trn'>Last</span>", sNext: "<span class='trn'>Next</span>", sPrevious: "<span class='trn'>Previous</span>" }, sEmptyTable: "<span class='trn'>No data available in table</span>", sInfo: "<span class='trn'>Showing</span> _START_ <span class='trn'>to</span> _END_ <span class='trn'>of</span> _TOTAL_ <span class='trn'>entries</span>", sInfoEmpty: "<span class='trn'>Showing</span> 0 <span class='trn'>to</span> 0 <span class='trn'>of</span> 0 <span class='trn'>entries</span>", sInfoFiltered:"(<span class='trn'>filtered from</span> _MAX_ <span class='trn'>total entries</span>)",sInfoPostFix:"",sDecimal:"",
        sThousands: ",", sLengthMenu: "<span class='trn'>Show</span> _MENU_ <span class='trn'>entries</span>", sLoadingRecords: "Loading...", sProcessing: "Processing...", sSearch: "<span class='trn'>Search:</span>", sSearchPlaceholder: "", sUrl: "", sZeroRecords:"<span class='trn'>No matching records found</span>"},oSearch:h.extend({},n.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};$(n.defaults);n.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc",
